...
@section('description')
<p>This pull request includes changes and recommendations for crafting your application <em>"The Laravel Way"</em>. Feel free to commit any additional changes to the <code>shift-{{ $number }}</code> branch.</p>
