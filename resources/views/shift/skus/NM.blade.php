...
@section('description')
<p>This pull request includes changes for namespacing models under <code>App\Models</code>. Feel free to commit any additional changes to the <code>shift-{{ $number }}</code> branch.</p>
