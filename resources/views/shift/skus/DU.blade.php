...
@section('description')
<p>This pull request includes minor version updates for your package dependencies as well as major version updates for packages with known compatibility. Feel free to commit any additional changes to the <code>shift-{{ $number }}</code> branch.</p>
