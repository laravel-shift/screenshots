...
<ul class="ml-6 list-disc">
    ...
    <li class="mb-1">Run <code class="px-1 rounded bg-gray-100 text-xs">composer update</code> (if the scripts fail, add <code class="px-1 rounded bg-gray-100 text-xs">--no-scripts</code>)</li>
