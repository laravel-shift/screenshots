        ...
        <div class="ml-[4.5rem] py-8 border-l-2 border-gray-300">
            ...
            @foreach($shift->commits as $commit)
                <li class="flex items-center justify-between">
                    ...
                    <div>
                        <span class="px-2 py-1 text-xs text-green-700 border border-gray-300 rounded-full mr-2">Verified</span>
                        @if ($loop->last)
                        ...
                        @endif
                        <span class="font-mono py-1 text-xs leading-5 text-gray-600">{{ commit_sha() }}</span>
                    </div>
                </li>
                @endforeach
                <li>
                    <div class="-ml-[0.4rem] mt-3 flex items-baseline">
                        <div class="h-8 w-8 border-2 border-white flex items-center justify-center bg-github-merged text-white rounded-full">
                        ...
                        <div class="ml-2">
                            <div class="flex items-center gap-2">
                                <img
                                    ...
                                    class="inline-block h-5 w-5 rounded-full"
                                />
                                <span class="text-gray-700 text-xs">merged commit <b>{{ commit_sha() }}</b> into <code class="bg-github-branch-bg text-github-branch-fg">{{ $source }}</code> {{ $shift->published_at->diffForHumans() }}</span>
                            </div>
                            <p class="mt-1 text-gray-700 text-xs">1 check passed</p>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <div class="ml-5 w-80 divide-y">
        <div class="py-4">
            ...
            <div class="mt-3 text-gray-600 text-xs font-semibold">
                <img class="w-5 h-5 rounded-full mr-1 inline-block" src="https://avatars.githubusercontent.com/u/4977161?s=40&amp;v=4">
                jessarcher
            </div>
        </div>
        <div class="py-4">
